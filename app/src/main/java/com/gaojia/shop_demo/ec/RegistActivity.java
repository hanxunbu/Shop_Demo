...
import com.gaojia.shop_demo.utils.ToastUtils;
...
public class RegistActivity extends BaseActivity {
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case REG_SUCCESS:
                    ToastUtils.showToast(getApplicationContext(), "注册成功,请先登录");
                    break;
                case REG_FAILED:
                    if (getApplicationContext() == null) KLog.e("是空了");
                    ToastUtils.showToast(getApplicationContext(), "该用户已经注册过了,请换一个号码再试");
